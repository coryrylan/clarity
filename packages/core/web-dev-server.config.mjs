      ...
      inject: {
        importMap: {
          imports: {
            ...
            '@cds/core/icon/shapes/bars.js': '/dist/core/icon/shapes/bars.js',
            '@cds/core/icon/shapes/filter-grid.js': '/dist/core/icon/shapes/filter-grid.js',
            '@cds/core/icon/shapes/filter.js': '/dist/core/icon/shapes/filter.js',
            ...
            '@cds/core/grid/index.js': '/dist/core/grid/index.js',
            '@cds/core/grid/register.js': '/dist/core/grid/register.js',
