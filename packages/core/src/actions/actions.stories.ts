...
import { baseStyles, getElementStorybookArgTypes, registerElementSafely, state } from '@cds/core/internal';
...
export default {
  ...
  argTypes: getElementStorybookArgTypes('cds-action', customElements),
  parameters: {
